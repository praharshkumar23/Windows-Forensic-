...
```bash
LogParser.exe ^
"SELECT TimeGenerated, EventID, EventTypeName, Message 
FROM FailedLogins.evtx" ^
-i:EVT ^
-o:CSV > FailedLogins.csv
✅ Expected Outcome
...
Copy code
Get-WinEvent -FilterHashtable @{LogName='Security'; Id=4625} |
Out-File FailedLogins.txt
✅ Expected Outcome
Console output of failed logins

Saved forensic report
...
- No legal risk wording  

---

If you want next, I can:
- Add **diagrams**
- Add **PowerShell scripts folder**
- Create **SOC case study version**
- Convert this into **college project report**
